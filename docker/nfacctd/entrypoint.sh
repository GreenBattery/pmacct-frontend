...
export DB_HOST DB_USER DB_PASSWORD DB_NAME NFACCTD_PORT LOCAL_SUBNET
...
envsubst '$DB_HOST $DB_USER $DB_PASSWORD $DB_NAME $NFACCTD_PORT $LOCAL_SUBNET' < /etc/pmacct/nfacctd.conf.template > /etc/pmacct/nfacctd.conf
